...
## 🎈 Repo structure <a name="repo_structure"></a>
...
parameters for processing genomic data on Azure cloud services (Azure batch, storage settings and also Docker support)|

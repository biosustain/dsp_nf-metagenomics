...
#BSUB -o /work3/apca/orange_peel/log/Output_%J.out 
#BSUB -e /work3/apca/orange_peel/log/Output_%J.err 
...
DB_DIR=/work3/apca/orange_peel/orange_genome
...
/zhome/f5/1/58775/.local/bin/bowtie2-build $PROJECT_DIR/orange_genome/GCF_022201045.2_DVS_A1.0_genomic.fna $DB_DIR/orange_genome 
